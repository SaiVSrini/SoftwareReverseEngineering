...
#             continue
#         elif any(x in lower_line for x in ['keys deleted', 'values deleted', 'values modified', 'files added', 'files deleted']):
#             current_section = None
#             continue
...
#             # Every line is just a registry key path
#             entry = RegistryEntry(
#                 reg_key=line,
#                 value_name="",
#                 file_path=""
...
#             # Example: HKLM\SYSTEM\...SomeKey\SomeField: "DataHere"
